    ...
    return (
        <>
          ...
          <div className="tfoot">  
              ...
              <button className="btn btn-danger btn-circle" onClick={hacer.handleCompra}> Finalizar Pedido </button>
              <LinkContainer to="/">
                <button className="btn btn-primary btn-circle" > Regresar </button>
              </LinkContainer>
          </div>  
    </>
    )
